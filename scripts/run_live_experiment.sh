...
: "${PLATOON_ACCEL_MAX_STEPS:=450}"
: "${PLATOON_EVAL_EPISODES:=2}"
: "${PLATOON_EVAL_MAX_STEPS:=${PLATOON_MAX_EPISODE_STEPS}}"
export PLATOON_USE_ROS PLATOON_TOTAL_STEPS PLATOON_STEPS_PER_EPOCH PLATOON_UPDATE_ITERS PLATOON_TORCH_THREADS PLATOON_MAX_EPISODE_STEPS PLATOON_CRUISE_STEPS_MIN PLATOON_CRUISE_STEPS_MAX PLATOON_ACCEL_MAX_STEPS PLATOON_EVAL_EPISODES PLATOON_EVAL_MAX_STEPS
